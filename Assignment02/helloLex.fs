...
and Tokenize  lexbuf =
  ...
  | 0 -> ( 
# 9 "Assignment02/helloLex.fsl"
                                     LexBuffer<char>.LexemeString lexbuf 
# 27 "Assignment02/helloLex.fs"
          )
  | 1 -> ( 
# 10 "Assignment02/helloLex.fsl"
                                     failwith "Lexer error: illegal symbol" 
# 32 "Assignment02/helloLex.fs"
          )
  | _ -> failwith "Tokenize"

# 13 "Assignment02/helloLex.fsl"
  // ending
...
# 3000000 "Assignment02/helloLex.fs"
