...
let rec typ (e : tyexpr) (env : typ env) : typ =
    ...
    | ListExpr(lst, t) ->                                                 (* CHANGED FOR ASSIGNMENT 5 *)
      match lst |> List.forall (fun a -> typ a env = t) with              (* CHANGED FOR ASSIGNMENT 5 *)
        | true -> TypL(t)                                                 (* CHANGED FOR ASSIGNMENT 5 *)
        | _ -> failwith ("ListExpr: Not all element share the list type") (* CHANGED FOR ASSIGNMENT 5 *)
    | Call(Var f, eArg) -> 
